                        ...
                        <div class="col-md-12">
                            <div class="white_shd full margin_bottom_30">
                                ...
                                <div class="table_section padding_infor_info">
                                    ...
                                    <form id="formAdicionar" method="post" action="php/controller/adicionar/add_subcategoria.php">

                                        <div class="form-row">


                                            <div class="form-group col-md-4">
                                                <input type="text" name="s_nome" id="s_nome" class="form-control" placeholder="Nome da SubCategoria">
                                            </div> <!-- form-group end.// -->


                                            <div class="col-md-4 form-group">
                                                <input name="s_descricao" id="s_descricao" class="form-control" placeholder=" Descrição ">
                                            </div> <!-- form-group end.// -->
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 form-group">
                                                    <label class=newbtn>
                                                        ...
                                                        <input id="s_imagem" name="s_imagem" class='pis form-control' onchange="readURL(this);" type="file" accept="image/*">
                                                    </label>
                                                </div>
                                        ...
                                        <div class="form-group  col-md-12 ">
                                            <button type="submit" id="bt_gravar" class="btn btn-primary btn-block"> Adicionar SubCategoria <i class="fa fa-plus"></i> </button>
                                        </div> <!-- form-group// -->
...
<script>
    ...
    $("#formAdicionar").on('submit',(function(e) {
        ...
        var s_nome = $('#s_nome').val();
        var s_descricao = $('#s_descricao').val();
        var s_categoria = $('#s_categoria').val();
        ...
        if(s_nome === ""){
            ...
            swal({
                title: "Aviso!",
                text: "Deve selecionar 1 categoria!",
                icon: "warning",
                button: "Ok!"
            });
        }else {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (result.estado === 'sucesso') {
                        ...
                        swal({
                            title: "Óptimo, SubCategoria registada!",
                            icon: "success",
                            button: "Ok!"
                        }).then(function () {
                        ...
                        swal({
                            title: "Erro, a Subcategoria não foi criada!",
                            icon: "error",
                            button: "Ok!"
                        });
                    }
