                            ...
                            <div class="white_shd full margin_bottom_30">
                                <div class="full graph_head">
                                    <div class="heading1 margin_0">
                                        <h2>Tabela de Motoristas</h2>

                                    </div>
                                    <div class="button_block"><button type="button" data-target="#adicionarUtilizadorModal" data-toggle="modal" class="pull-right btn cur-p btn-primary">Adicionar Motorista</button></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Adicionar Motorista do Sistema</h4>
                ...
                <div class="modal-body">
                    ...
                    <form id="formAdicionar" method="post" action="php/controller/adicionar/add_utilizador.php">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <input type="number" name="u_grupo" id="u_grupo" value="3" class="form-control" placeholder="Nome do Produto" readonly>
                            </div> <!-- form-group end.// -->
                        ...
                        <div class="form-group  col-md-12 ">
                            <button type="submit" id="bt_gravar" class="btn btn-primary btn-block"> Adicionar Motorista <i class="fa fa-plus"></i> </button>
                        </div> <!-- form-group// -->
